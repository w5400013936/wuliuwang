// pages/network-manage/network-manage.js 
...
Page({
  ...
  onLoad: function(options) {
    ...
    that.request()
    WxNotificationCenter.addNotification(getApp().shuaXin.faBuWangDian, that.guanBi, that)
  },
   ...
   */
  onUnload: function() {
    WxNotificationCenter.removeNotification(getApp().shuaXin.faBuWangDian, this)
  },
  guanBi(){
    wx.navigateBack({
      delta:1
  ...
  bianJiTap(e){
    wx.navigateTo({
      url: '/pages/add-network/add-network?bean=' + JSON.stringify(this.data.profile) + "&bean1=" + JSON.stringify(this.data.userInfo1) + "&value=" + JSON.stringify(e.currentTarget.dataset.item),
    })
  },
  ...
  addNet() {
    wx.navigateTo({
      url: '/pages/add-network/add-network?bean=' + JSON.stringify(this.data.profile) + "&bean1=" + JSON.stringify(this.data.userInfo1),
    })
  },
