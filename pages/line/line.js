...
Page({
  ...
  detail(e){
    wx.navigateTo({
      url: '/pages/line-details/line-details?bean='+JSON.stringify(this.data.rows[e.currentTarget.dataset.index]),
    })
  },
  /**
   * 点击省
  ...
  call(e) {
    var that = this
    var mobile = that.data.rows[e.currentTarget.dataset.index].minfo.mobile
    getApp().call(mobile)
  },
  ...
  companyTap(e){
    ...
    wx.navigateTo({
      url: '/pages/companyInfos/home/home?id=' + id,
    })
  },
})